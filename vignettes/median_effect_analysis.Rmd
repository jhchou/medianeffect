...
Fitting a linear regression of $log\left(\frac{f_a}{f_u}\right)$ versus $log(D)$ allows determination of the $m$ and $D_m$ parameters.
...
… where for a given fractional affect $f_a$,

* $(D)_i$ is the dose of drug _i_ within the combination of _n_ drugs which results in a fractional effect of $f_a$
* $(D_x)_i$ is the dose of drug _i_ alone which results in a fractional effect of $f_a$
...
The reciprocal of each of the terms of the combination index (CI) reflects the fold-reduction (dose reduction index, DRI) of drug _i_ within the drug combination, to yield a given fractional affect $f_a$.
